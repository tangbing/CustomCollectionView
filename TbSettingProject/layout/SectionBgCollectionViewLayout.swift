...
@objc protocol SectionBgCollectionViewDelegate: UICollectionViewDelegateFlowLayout {
...
class SectionBgCollectionViewLayout: UICollectionViewFlowLayout {
    ...
    override func prepare() {
        ...
        guard let numberOfSections = self.collectionView?.numberOfSections,
            let delegate = self.collectionView?.delegate as? SectionBgCollectionViewDelegate
            else {
                return
        }
